...
var speedOfSelectBoxSliding = 500;	// Milliseconds between changing year and hour when holding mouse over "-" and "+" - lower value = faster
...
switch(languageCode){
	case "ru":	/* English */
		...
		var monthArrayShort = ['Янв','Фев','Март','Апр','Май','Июн','Июл','Авг','Сен','Окт','Ноя','Дек'];
